...
type UserRepository interface {
	ListUser(ctx context.Context, order string, limit int) (UserListEntiy, error)
}
...
func (r *userRepository) ListUser(ctx context.Context, order string, limit int) (UserListEntiy, error) {
...
func (r *userRepository) fetchUsers(query string, args ...interface{}) (UserListEntiy, error) {
	var userListEntity UserListEntiy
